...
class MyMainWindow(qtw.QWidget):
	def __init__(self):
		...
		self.setLayout(qtw.QVBoxLayout())  # layout for the mainwindow		
		self.keypad()
		self.show()
	...
	def keypad(self):
		...
		container.layout().addWidget(btn_div, 5,3,1,1)
	...
	def func_press(self, operator):
		tempo_string = ''.join(self.temp_nums)
		self.fin_nums.append(tempo_string)
...
mw = MyMainWindow()
app.setStyle(qtw.QStyleFactory.create('Fusion'))  # some kind of styling. optional
app.exec_()
